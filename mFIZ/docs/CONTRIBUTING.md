...
Packages, such as the *motor_apis* package, should function independently
of mFIZ and Maya. Packages may be integrated with this repository via the following
...
- This repository is organized with respect to what Maya expects to see in its
  [modules](http://help.autodesk.com/view/MAYAUL/2018/ENU/?guid=__files_GUID_CB76E356_753B_4837_8C5B_3296C14872CA_htm) directory. Directories within mFIZ, such as *scripts* and *icons*
...
- Document everything!
    - Some documentation may require a full readme.
      If the documentation is for mFIZ itself, place it in *mFIZ/docs*. If it's
      for a package (such as *motor_apis*), place it in the package directory and
...
- Prefer common dimensions of UI elements, such as separators, and maintain the
  existing dimensions and proportions of the mFIZ window.


### Pro tips
 
- Call `reload(*)` after `import *` so changes you make to your code can be loaded by
  mFIZ when it reopens without having to reopen Maya all the time.
