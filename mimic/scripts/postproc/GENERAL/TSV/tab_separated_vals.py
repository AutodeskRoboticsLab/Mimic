...
from . import tab_separated_vals_config
...
class SimpleTSVProcessor(postproc.PostProcessor):
    """
    ...
    def __init__(self):
        ...
        super(SimpleTSVProcessor, self).__init__(
            type_robot='GENERAL',
            type_processor='TSV',
            program_file_extension=tab_separated_vals_config.DEFAULT_FILE_EXTENSION,
            def_program_template=tab_separated_vals_config.DEFAULT_PROGRAM)
