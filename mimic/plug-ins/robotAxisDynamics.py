...
class robotAxisDynamics(OpenMaya.MPxNode):    
    ...
    def compute(self, pPlug, pDataBlock):
        ...
        if live:
            ...
            p__2 = plug.asMAngle(mdg__2).asDegrees()
            p__1 = plug.asMAngle(mdg__1).asDegrees()
            p_0 = plug.asMAngle(mdg_0).asDegrees()
            p_1 = plug.asMAngle(mdg_1).asDegrees()
            p_2 = plug.asMAngle(mdg_2).asDegrees()
